...
export default function TracingBeam({ children, className = '' }: TracingBeamProps) {
  ...
  return (
    <motion.div ref={ref} className={`relative mx-auto w-full ${className}`}>
        ...
        >
          ...
          <defs>
            <motion.linearGradient
              ...
              y2={y2}
            >
              <stop stopColor="#00D4AA" stopOpacity="0" />
              <stop stopColor="#00D4AA" />
              <stop offset="0.325" stopColor="#FF6B35" />
      ...
      <div ref={contentRef} className="md:pl-24">
        {children}
      </div>
    </motion.div>
  );
